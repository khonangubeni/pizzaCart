...
function payment(){
 ...
 if (paymentAmt == totalCart){
    message.innerHTML = "Thank you, Enjoy your Pizza!";
 } else if (paymentAmt > totalCart) {
    var change = paymentAmt - totalCart;
    message.innerHTML = "Enjoy your Pizza, here's your Change R" + change.toFixed(2);
 } else {
    message.innerHTML = "Oops, that's not enough money!";
 }
}
